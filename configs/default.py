...
_C.MODEL = CN()
_C.MODEL.INPUT_SIZE = 132#132
_C.MODEL.TARGET_SIZE = 59
_C.MODEL.MAX_SIZE = 59
_C.MODEL.MIN_SIZE = 44
#_C.MODEL.MAX_SIZE = 73
#_C.MODEL.MIN_SIZE = 73
_C.MODEL.SEARCH_SCALE = 3.048 #4 is worser than 3? not the larger the better.
#3.15>3.1,3.17>3.2~3.16~2.9>3.3~3

_C.MODEL.SCALES = [0.96263,1, 1.04322]
_C.MODEL.SCALE_WEIGHTS = [0.98183, 1, 1.00696]
...
_C.TEST.WINDOW_INFLUENCE = 0.385
_C.TEST.SCALE_INFLUENCE = 0.427
_C.TEST.POSITION_INFLUENCE = 0.427
...
_C.TEST.APCE_LOW_THRESHOLD = 0.44577
_C.TEST.APCE_HIGH_THRESHOLD = 0.86769
_C.TEST.CG_ITER = 19
_C.TEST.ONLINE_INFLUENCE = 0.132
_C.TEST.NORM_THRESHOLD = 0.459

_C.TEST.IOU_THRESHOLD = 0.316
_C.TEST.min_iou = 0.398
_C.TEST.boxes_per_frame = 44
_C.TEST.sigma_factor = 0.0348

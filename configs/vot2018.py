...
_C.MODEL.SEARCH_SCALE = 4.81 #4 is worser than 3? not the larger the better.
#3.15>3.1,3.17>3.2~3.16~2.9>3.3~3

_C.MODEL.SCALES = [0.95648,1, 1.06006]
_C.MODEL.SCALE_WEIGHTS = [0.98279, 1, 1.00621]
...
_C.TEST.WINDOW_INFLUENCE = 0.427
...
_C.TEST.APCE_LOW_THRESHOLD = 0.11889
_C.TEST.APCE_HIGH_THRESHOLD = 0.51449
_C.TEST.CG_ITER = 14
_C.TEST.ONLINE_INFLUENCE = 0.076
_C.TEST.NORM_THRESHOLD = 0.237

...
class TC128Video(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(TC128Video, self).__init__(name, root, video_dir,
...
class TC128Dataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(TC128Dataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = TC128Video(video,
                                          dataset_root,
